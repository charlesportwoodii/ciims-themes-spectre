...
<?php else: ?>
	<div class="alert alert-info">
		<?php echo Yii::t('SpectreTheme.main', "{{woah}} It looks like there aren't any posts in this category yet. Why don't you check out some of our other pages or check back later?", 
			array(
				'{{woah}}' => CHtml::tag('strong', array(), Yii::t('SpectreTheme.main', 'Woah!'))
		)); ?>
	</div>
<?php endif; ?>

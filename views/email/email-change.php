...
<?php echo Yii::t('themes.spectre.main.main', 'This is a notification that a request to change your email address was made on {{name}}. To approve this change, please visit {{link}}', array(

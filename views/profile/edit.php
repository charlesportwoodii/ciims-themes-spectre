<div class="login-container edit-profile">
  <h1 class="content-subhead"><?php echo Yii::t('themes.spectre.main', 'Update Your Profile'); ?></h1>
    <?php $form=$this->beginWidget('cii.widgets.CiiActiveForm', array(
        ...
        <div class="pure-group">
            <h3><?php echo Yii::t('themes.spectre.main', 'Enter Your Current Password'); ?></h3>
            <p><?php echo Yii::t('themes.spectre.main', 'Enter your current password to make any changes to your account'); ?></p>
        ...
        <div class="pure-group">
            <h3><?php echo Yii::t('themes.spectre.main', 'Change Your Password'); ?></h3>
        ...
        <div class="pure-group">
            <h3><?php echo Yii::t('themes.spectre.main', 'Change Your Email Address'); ?></h3>
            <?php echo $form->textField($model, 'email', array('class' => 'pure-u-1', 'placeholder' => $model->getAttributeLabel('email') )); ?>
            <p>
                <?php echo Yii::t('themes.spectre.main', 'Awaiting activation for {{email}}. {{resend}}', array(
                    '{{email}}' => CHtml::tag('strong', array(), $model->getNewEmail()),
                    '{{resend}}' => CHtml::link(Yii::t('themes.spectre.main', 'Resend?'), $this->createUrl('profile/resend'))
                )); ?>
            </p>
        </div>

        <div class="pure-group">
            <h3><?php echo Yii::t('themes.spectre.main', 'Change Your Information'); ?></h3>

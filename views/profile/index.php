<div class="content pure-u-1 about-container">
	...
	<?php if (!Yii::app()->user->isGuest): ?>
		<div class="pure-menu-open pure-menu-horizontal pull-right">
		    <ul>
		        <li><?php echo CHtml::link(Yii::t('themes.spectre.main.main', 'edit'), $this->createUrl('profile/edit')); ?></li>
		    </ul>
		</div>
			...
			<div class=" pure-u-1-2 pull-left">
				<dl>
					<div class="dl-container">
						<dt><?php echo Yii::t('themes.spectre.main.main', 'Display Name'); ?></dt>
						<dd><?php echo $model->displayName; ?></dd>
					</div>

					<div class="dl-container">
						<dt><?php echo Yii::t('themes.spectre.main.main', 'Reputation'); ?></dt>
						<dd><?php echo $model->getReputation(); ?></dd>
					</div>

					<div class="dl-container">
						<dt><?php echo Yii::t('themes.spectre.main.main', 'Registered'); ?></dt>
	...
	<div class="post pure-u-1-2 pull-right container-50">
		<div class="post-inner">
			<h2><?php echo Yii::t('themes.spectre.main.main', 'About'); ?></h2>
			<?php if ($model->about == ''): ?>
				<p class="alert alert-info"><?php echo Yii::t('themes.spectre.main.main', 'This user has not provided any information for themselves.'); ?></p>
			<?php else: ?>
...
<div class="content pure-u-1  about-container">
	...
	<?php if ($contentCount > 0): ?>
		...
		<div class="post pure-u-1-2 pull-left container-50">
			<div class="post-inner">
				<h2><?php echo Yii::t('themes.spectre.main.main', 'Recent Posts'); ?></h2>
				<?php 
					$content = new Content;
	...
	<?php if (Cii::getCommentProvider() == 'CiiComments'): ?>
		...
		<div class="post pure-u-1-2 pull-right container-50">
			<div class="post-inner">
				<h2><?php echo Yii::t('themes.spectre.main.main', 'Recent Comments'); ?> </h2>

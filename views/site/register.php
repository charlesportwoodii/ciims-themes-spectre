<div class="modal-container">
    <h1 class="content-subhead"><?php echo Yii::t('SpectreTheme.main', 'Create a new Account'); ?></h1>
    ...
    <?php if (!Yii::app()->user->isGuest): ?>
        <div class="alert alert-info">
            <?php echo Yii::t('SpectreTheme.main', "{{headsup}} Looks like you're already logged in as {{email}}", array(
    ...
    <?php else: ?>
        ...
        <div class="pull-left">
            <?php echo CHtml::link(Yii::t('SpectreTheme.main', 'login'), $this->createUrl('/login')); ?>
            <span> | </span>
    ...
    <?php if (Yii::app()->user->isGuest): ?>
        ...
        <div class="clearfix" style="border-bottom: 1px solid #aaa; margin: 15px;"></div>
            <span class="login-form-links"><?php echo Yii::t('SpectreTheme.main', 'Or register with one of these social networks'); ?></span>
        <?php endif; ?>
        <div class="clearfix"></div>

<div class="modal-container">
   <h1 class="content-subhead"><?php echo Yii::t('themes.spectre.main', 'Reset Your Password'); ?></h1>
    <p class="pull-text-left"><?php echo Yii::t('themes.spectre.main', 'Enter your new password twice to reset your password.'); ?></p>

<div class="modal-container">
    <h1 class="content-subhead"><?php echo Yii::t('themes.spectre.main.main', 'Change Your Email Address'); ?></41>
    <hr class="clearfix"/>
    <p class="pull-text-left"><?php echo Yii::t('themes.spectre.main.main', 'Enter your current password to change your email address.'); ?></p>

<div class="modal-container">
    <h1 class="content-subhead"><?php echo Yii::t('SpectreTheme.main', 'Change Your Email Address'); ?></41>
    <hr class="clearfix"/>
    <p class="pull-text-left"><?php echo Yii::t('SpectreTheme.main', 'Enter your current password to change your email address.'); ?></p>

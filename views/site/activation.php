...
<div class="modal-container">
    <<h1 class="content-subhead"><?php echo Yii::t('themes.spectre.main.main', 'Activate your Account'); ?></h1>
    <p class="pull-text-left"><?php echo Yii::t('themes.spectre.main.main', 'Enter the password you registered with to activate your account.'); ?></p>

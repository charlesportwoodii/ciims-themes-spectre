	...
	<div class="<?php echo $comment->author->id == $comment->content->author->id ? 'green-indicator author-indicator' : NULL; ?>">
		...
		<div class="comment-body">
		    <?php if ($comment->approved == -2): ?>
		        <em class="flagged"><?php echo Yii::t('SpectreTheme', 'Comment has been redacted'); ?></em>
		    <?php else: ?>
		...
		<?php $form = $this->beginWidget('CActiveForm', array(
			...
			<div id="sharebox-<?php echo $comment->id; ?>" class="comment-box">
                ...
                <div id="b-<?php echo $comment->id; ?>" style="color:#999"><?php echo Yii::t('SpectreTheme', 'Comment on this post'); ?></div> 
            </div>
...
<script type="text/javascript">
	$(document).ready(function() {
		SpectreTheme.loadComment(<?php echo $comment->id; ?>);
	});
</script>